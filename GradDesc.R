#What is gradient descent and why is it important? It is an optimization algorithm used to train machine learning models. 
#In this code, I will build my own algorithm for it.
...
#Slope of randx is -.7477 and intercept is 194.71
...
#Run below and get roughly the same slope and intercept as the lm output
